...
mostrar mixto`,
      ...
      challenge:
        "Crea tres listas diferentes: una con tus 5 números favoritos, otra con los nombres de 3 amigos, y una mixta con tu nombre, edad y ciudad. Muéstralas todas.",
    },
    {
...
mostrar "Nueva segunda fruta: " + frutas[1]`,
      ...
      challenge:
        "Crea una lista de 5 calificaciones. Muestra la primera y última nota. Luego cambia la tercera nota a 10 y muestra la lista completa.",
    },
    {
...
mostrar "Cantidad de frutas: " + frutas.longitud()`,
      ...
      challenge:
        "Crea una lista con los días de la semana (al menos 5). Usa los métodos para mostrar cuántos días hay, el primer día y el último día de tu lista.",
    },
    {
...
mostrar "Lista final: " + frutas`,
      ...
      challenge:
        "Crea una lista vacía `tareas = []`. Agrega 4 tareas diferentes. Muestra cuántas tareas tienes. Luego completa (remueve) 2 tareas y muestra la lista final.",
    },
    {
...
si frutas.contiene("manzana") {
    ...
    mostrar "No hay manzanas disponibles"
      ...
      challenge:
        "Crea una lista de 5 colores. Pide al usuario un color y usa `.contiene()` para verificar si ese color está en tu lista. Muestra un mensaje apropiado según el resultado.",
    },
    {
...
numeros.recorrer(funcion(elemento, indice) {
    mostrar "Posición " + indice + ": " + elemento
      ...
      challenge:
        "Crea una lista de precios [10, 25, 30, 15, 40]. Usa `.recorrer()` para calcular y mostrar cada precio con IVA (precio * 1.21). Al final, muestra el total.",
    },
    {
...
estudiantes.recorrer(funcion(nombre, indice) {
    mostrar nombre + ": " + notas[indice] + " puntos"
      ...
      challenge:
        "Crea un sistema de inventario: una lista de productos y otra de cantidades. Agrega 3 productos, muestra el inventario completo, verifica si tienes un producto específico, y calcula cuántos productos tienes en total.",
      summary:
  ...
  return (
    <LessonPage
      ...
      prevLessonTitle="Funciones Matemáticas"
