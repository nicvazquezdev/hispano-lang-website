...
mostrar "La raíz de " + numero + " es: " + raiz(numero)`,
      ...
      challenge:
        "Calcula la raíz cuadrada de 144 y 2 elevado a la 5. Muestra ambos resultados con mensajes descriptivos.",
    },
    {
...
mostrar "Seno de 90: " + seno(angulo)`,
      ...
      challenge:
        "Calcula el seno, coseno y tangente del ángulo 45. Muestra los tres resultados organizadamente.",
    },
    {
...
mostrar "Piso de " + medida + ": " + piso(medida)`,
      ...
      challenge:
        "Calcula cuántos paquetes de 6 unidades necesitas para 20 unidades (usa división y techo). Luego muestra cuántas unidades completas tienes en 25.7 (usa piso).",
    },
    {
...
mostrar "Logaritmo de 100: " + log100`,
      ...
      challenge:
        "Crea dos variables con números, una positiva y una negativa. Calcula el valor absoluto de ambas y su diferencia absoluta. Muestra todos los resultados.",
    },
    {
...
mostrar "Resultado del dado: " + dado`,
      ...
      challenge:
        "Simula tirar dos dados (1-6) y suma sus valores. Luego genera una temperatura aleatoria entre 15 y 35 grados. Muestra ambos resultados.",
    },
    {
...
mostrar "Promedio: " + prom`,
      ...
      challenge:
        "Tienes 5 calificaciones (85, 92, 78, 95, 88). Calcula y muestra: la nota más alta, la más baja, la suma total y el promedio. Luego determina si el promedio es >= 80 (aprobado con honores).",
    },
    {
...
mostrar "Distancia: " + distancia`,
      ...
      challenge:
        "Crea un juego de adivinanza: genera un número aleatorio entre 1 y 100. Pide al usuario un número. Calcula la diferencia absoluta entre ambos y muestra qué tan cerca estuvo (0-10: muy cerca, 11-30: cerca, 31+: lejos).",
      summary:
