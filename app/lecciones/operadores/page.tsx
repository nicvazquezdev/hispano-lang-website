...
mostrar "Resta: " + (a - b)`,
      ...
      challenge:
        "Crea dos variables con números de tu elección y muestra el resultado de las cuatro operaciones básicas (suma, resta, multiplicación, división) con mensajes descriptivos.",
    },
    {
...
mostrar "Módulo (resto): " + modulo`,
      ...
      challenge:
        "Crea un programa que calcule el área de un círculo. Pide el radio al usuario y usa la fórmula: área = 3.14159 * radio * radio.",
    },
    {
...
mostrar "a != b: " + (a != b)`,
      ...
      challenge:
        "Crea dos variables con edades y compara si la primera persona es mayor, menor o igual que la segunda. Muestra los resultados de las tres comparaciones.",
    },
    {
...
mostrar "¿Puede viajar?: " + puede_viajar`,
      ...
      challenge:
        "Simula un sistema de acceso: el usuario puede entrar si tiene tarjeta Y (tiene código O es administrador). Crea las variables y muestra si puede entrar.",
    },
    {
...
mostrar "Después de /= 4: " + x`,
      ...
      challenge:
        "Simula un sistema de puntos en un juego. Comienza con 100 puntos, suma 50 por una victoria, resta 20 por una derrota, y multiplica por 1.5 por un bonus. Muestra el resultado en cada paso.",
    },
    {
...
mostrar "¿Es mayor que 20?: " + es_grande`,
      ...
      challenge:
        "Crea un programa que calcule el IMC (Índice de Masa Corporal). Pide peso y altura al usuario, calcula IMC = peso / (altura * altura), y muestra si es menor, igual o mayor que 25.",
      summary:
  ...
  return (
    <LessonPage
      ...
      prevLessonTitle="Métodos de Strings"
