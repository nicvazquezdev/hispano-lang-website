...
mostrar "Programa terminado"`,
      ...
      challenge:
        "🧩 Desafío rápido: Crea una variable con tu edad y usa un condicional `si` para mostrar un mensaje solo si eres mayor de 21 años.",
    },
    {
...
mostrar "Gracias por usar el programa"`,
      ...
      challenge:
        "🧩 Desafío rápido: Pide un número al usuario y usa `si-sino` para mostrar si es par o impar. Pista: usa el operador módulo (%) para verificar si el resto de dividir entre 2 es 0.",
    },
    {
...
si edad >= 18 {
    ...
    mostrar "No puedes conducir aún"
      ...
      challenge:
        "🧩 Desafío rápido: Crea un programa que evalúe si un estudiante aprobó. Si la nota es >= 70, aprobó. Si aprobó Y la nota es >= 90, además muestra '¡Excelente!'. Si no aprobó, muestra 'Debes estudiar más'.",
    },
    {
...
si nota >= 90 {
    ...
    si nota >= 80 {
      ...
      challenge:
        "🧩 Desafío rápido: Crea un programa que categorice la temperatura: si >= 30 'Hace mucho calor', si >= 20 'Clima agradable', si >= 10 'Hace fresco', sino 'Hace frío'.",
    },
    {
...
si edad >= 18 y tiene_entrada {
    ...
    si edad < 18 {
      ...
      challenge:
        "🧩 Desafío rápido: Simula un sistema de login: el usuario puede entrar si (el nombre es 'admin' Y la contraseña es '1234') O (es_invitado es verdadero). Muestra mensajes apropiados.",
    },
    {
...
si temperatura > 30 {
    ...
    si temperatura > 20 {
      ...
      challenge:
        "🧩 Desafío rápido: Crea una calculadora de descuentos: si la compra es >= 100, descuento del 20%. Si es >= 50, descuento del 10%. Sino, sin descuento. Calcula y muestra el precio final.",
      summary:
