...
export const lessons: LessonInfo[] = [
  ...
  { id: 'constantes', title: 'Constantes', description: 'Valores que no pueden cambiar', emoji: '🔒', difficulty: 'Principiante', duration: '8 min' },
  ...
  // Strings (5-6)
  { id: 'metodos-strings', title: 'Métodos de Strings', description: 'Manipula y transforma texto', emoji: '🔤', difficulty: 'Principiante', duration: '25 min' },
  { id: 'template-strings', title: 'Template Strings', description: 'Interpolación de variables en texto', emoji: '📝', difficulty: 'Principiante', duration: '15 min' },
  ...
  { id: 'elegir-caso', title: 'Elegir/Caso', description: 'Múltiples caminos de decisión', emoji: '🎯', difficulty: 'Intermedio', duration: '20 min' },
  ...
  { id: 'bucles-avanzados', title: 'Bucles Avanzados', description: 'hacer/mientras y para cada', emoji: '🔁', difficulty: 'Intermedio', duration: '20 min' },
  ...
  { id: 'conversion-tipos', title: 'Conversión de Tipos', description: 'Transforma datos entre diferentes tipos', emoji: '🔄', difficulty: 'Intermedio', duration: '15 min' },
  { id: 'metodos-numericos', title: 'Métodos Numéricos', description: 'Operaciones especiales con números', emoji: '🔢', difficulty: 'Intermedio', duration: '15 min' },

  // Estructuras de Datos (17-18)
  { id: 'listas', title: 'Listas', description: 'Trabaja con colecciones de datos', emoji: '📋', difficulty: 'Intermedio', duration: '35 min' },
  { id: 'objetos', title: 'Objetos', description: 'Organiza datos con propiedades', emoji: '🗂️', difficulty: 'Intermedio', duration: '30 min' },

  // POO (19-20)
  { id: 'clases', title: 'Clases', description: 'Programación orientada a objetos', emoji: '🏗️', difficulty: 'Avanzado', duration: '35 min' },
  { id: 'herencia', title: 'Herencia', description: 'Extender clases con extiende y super', emoji: '🌳', difficulty: 'Avanzado', duration: '30 min' },
