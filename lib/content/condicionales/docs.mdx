...
<Output text={`¡Excelente! Tienes una A
...
<Output text={`Calificación: B - Muy Bueno
Cuadro de Honor`} />
...
<Output text={`¡Aprobaste la materia!
Muy buen desempeño`} />
...
<Output text={`Aprobaste ambas partes
...
<Output text={`=== REPORTE DE CALIFICACIONES ===
