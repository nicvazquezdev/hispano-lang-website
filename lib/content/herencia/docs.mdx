...
mostrar rect.nombre + ": " + texto(rect.calcularArea())
mostrar circ.nombre + ": " + texto(circ.calcularArea())`} />

<Output text={`Rectángulo: 50
Círculo: 153.93791`} />
...
<Output text={`=== INVENTARIO DE VEHÍCULOS ===
