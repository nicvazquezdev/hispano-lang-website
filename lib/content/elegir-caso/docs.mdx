...
<Output text={`Pizza de muzzarella`} />
...
<Output text={`Lunes - Matemática, Historia, Educación Física
...
<Output text={`Muy Bueno - 80 a 89 puntos
Buen trabajo`} />
...
<Output text={`=== SELECTOR DE DIFICULTAD DE EXAMEN ===
