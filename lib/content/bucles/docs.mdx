...
para (variable cancion = 1; cancion <= 3; cancion++) {
    mostrar "Reproduciendo track " + cancion
}`} />
...
¡DROP!
---
Reproduciendo track 1
Reproduciendo track 2
Reproduciendo track 3`} />
...
mostrar ""
mostrar "Reproducción completada"
...
mostrar "Energía baja, descansar"`} />

<Output text={`Ejemplo con PARA:
Repetición 1
Repetición 2
Repetición 3
