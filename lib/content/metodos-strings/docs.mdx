...
<Output text={`El título tiene 23 caracteres
...
<Output text={`MI DOCUMENTO IMPORTANTE
NO ME GUSTA ESTO
usuario@email.com
Hola, juan pérez`} />
...
<Output text={`Con espacios: '   Hola mundo   '
...
<Output text={`Hola universo, universo feliz
