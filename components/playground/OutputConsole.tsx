...
export default function OutputConsole({
  ...
  return (
    <div className="bg-[#111] border border-slate-700 rounded-lg overflow-hidden h-full flex flex-col">
      {/* Header */}
      <div className="bg-[#111] px-4 py-2.5 flex items-center justify-between border-b border-[#3e3e42]">
      ...
      <div
        ref={consoleRef}
        className="flex-1 p-3 overflow-y-auto bg-[#111] font-mono text-xs"
      >
      ...
      {/* Footer */}
      <div className="bg-[#111] px-4 py-2 border-t border-[#3e3e42] text-xs text-[#858585]">
        Salida del programa
      </div>
    </div>
  );
